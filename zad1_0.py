...
class Auto:
    def __init__(self, brand_list):
        self.brand = random.choice(list(brand_list.keys())) # Fix: Added keys() method to get the list of keys
...
class Job:
    def __init__(self, job_list):
        self.job = random.choice(list(job_list.keys())) # Fix: Added keys() method to get the list of keys
